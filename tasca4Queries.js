...
db.restaurants.find({$and: [{cuisine: {$ne: {$regex: 'American', $options: 'x'}}, 'grades.score': {$gt: 70}, 'address.coord.0': {$lt:-65.754168}}]})
...
db.restaurants.find({cuisine: {$ne: {$regex: 'American', $options: 'x'}}, 'grades.score': {$gt: 70}, 'address.coord.0': {$lt:-65.754168}})
...
db.restaurants.find({cuisine: {$ne: {$regex: 'American', $options: 'x'}}, 'grades.grade': 'A', borough: {$ne: 'Brooklyn'}}).sort({cuisine: -1})
...
db.restaurants.find({borough: 'Bronx', $or: [{cuisine: {$regex: 'American', $options: 'x'}}, {cuisine: 'Chinese'}]})
...
db.restaurants.find({$nor: [{cuisine: {$in: ['American ', 'Chinese']}}, {name: {$regex: /^Wil/}}]}, {_id: 0, restaurant_id: 1, name: 1, borough: 1, cuisine: 1})
...
db.restaurants.find({"address.coord.1": {$lte: 52, $gt: 42 }}, {_id: 0, restaurant_id: 1, name: 1, address: 1})
